const products = [
  {
    id: 1,
    image: 'https://www.junaidjamshed.com/media/catalog/product/2/5/25-8038.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
  ...
  {
    id: 2,
    image: 'https://www.junaidjamshed.com/media/catalog/product/2/5/25-8036_1_.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
  ...
  {
    id: 3,
    image: 'https://www.junaidjamshed.com/media/catalog/product/2/5/25-8034_1_.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
  ...
  {
    id: 4,
    image: 'https://www.junaidjamshed.com/media/catalog/product/8/0/8033_1_.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
    name: 'GREEN LAWN EMBROIDERED KURTI',
    price: 'PKR 4,690.00',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
  },
  {
    id: 5,
    image: 'https://www.junaidjamshed.com/media/catalog/product/j/j/jjbl-25-128_1_.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
    name: 'GREEN LAWN EMBROIDERED KURTI',
    price: 'PKR 4,690.00',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
  },
