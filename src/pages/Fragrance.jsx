const products = [
  {
    id: 1,
    image: 'https://www.junaidjamshed.com/media/catalog/product/b/o/bottle_1_1.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
  ...
  {
    id: 2,
    image: 'https://www.junaidjamshed.com/media/catalog/product/p/o/pour-femme-j._1.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
  ...
  {
    id: 3,
    image: 'https://www.junaidjamshed.com/media/catalog/product/m/a/marjaan-01.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
  ...
  {
    id: 4,
    image: 'https://www.junaidjamshed.com/media/catalog/product/5/0/502_for_her_1.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=300&width=240&canvas=240:300&dpr=2',
    name: 'GREEN LAWN EMBROIDERED KURTI',
    price: 'PKR 4,690.00',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
  },
